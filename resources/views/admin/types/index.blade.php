                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex justify-end gap-4">
                                    ...
                                    @can('admin.types.destroy')
                                        <button data-url="{{ route('admin.types.delete', $type) }}" class="btn-modal-delete p-2 rounded-lg font-medium text-gray-800 hover:text-gray-400 focus:outline-none focus:ring focus:ring-gray-400">
