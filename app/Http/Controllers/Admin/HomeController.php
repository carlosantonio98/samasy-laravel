...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.index', compact('amountSales', 'amountProducts', 'amountTypes', 'amountFlavors', 'amountSalesByDay', 'totalMoney', 'monthMoney', 'dayMoney', 'chartOne', 'chartTwo', 'sales'));
    }
}
